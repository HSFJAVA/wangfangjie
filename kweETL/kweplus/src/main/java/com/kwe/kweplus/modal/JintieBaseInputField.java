...
public class JintieBaseInputField {
    private Integer id;

    private String jintieField;
    ...
    public String getJintieField() {
        return jintieField;
    }

    public void setJintieField(String jintieField) {
        this.jintieField = jintieField == null ? null : jintieField.trim();
    }
    ...
    public String toString() {
        return "JintieBaseInputField{" +
                "id=" + id +
                ", jintieField='" + jintieField + '\'' +
                ", field='" + field + '\'' +
                ", remarks1='" + remarks1 + '\'' +
                ", remarks2='" + remarks2 + '\'' +
                ", remarks3='" + remarks3 + '\'' +
