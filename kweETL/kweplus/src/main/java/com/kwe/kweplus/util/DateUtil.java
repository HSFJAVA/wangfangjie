...
public class DateUtil {
	...
	public final static SimpleDateFormat sdf24Time = new SimpleDateFormat("HHmmss");
	 ...
	 * @return
	 */
	public static String getSdf24Time() {
		return sdf24Time.format(new Date());
	}
	/**
	 * 获取yyyyMMddHHmmss格式
	 * @return
	...
	* @author fh
	 ...
	 * @return
	 */
	public static Date fomatDate(String date,SimpleDateFormat fmt) {
		if (MyUtils.isEmpty(date)) {
			return null;
		}
		try {
			return fmt.parse(date);
