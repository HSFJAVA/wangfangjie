<template>
    ...
    <div >
        <div class="loginBox">
            <div class="loginPng">
                <img class="imgBack" src="../../assets/image/u1.png" alt="">
            </div> 
            <div class="loginInput">
                <el-form  status-icon :model="ruleForm"  class="demo-ruleForm" label-width="80px" @submit="submitForm">
...
export default {
    ...
    methods: {
        ...
        submitForm () {
          ...
          const _this = this;
         this.$http
              .get(`${process.env.VUE_APP_BASE_API}kwe/index/login?userName=${this.ruleForm.name}&passwd=${this.ruleForm.password}`)
              .then(function(resp) {
                if(resp.data === "error") {
                              _this.$notify.error({
                                title: '错误',
